...
<tr>
<td colspan="8" align="center"><h2>update your account: </h2>


</td>

</tr>
<tr><td align="right">Customer Name:</td><td><input type="text" name="c_name" value="<?php echo $name;?>"</td></tr>

<tr><td align="right">Customer Email:</td>
<td><input type="text" name="c_email" value="<?php echo $email;?>"></td>
</tr>
<tr><td align="right">Customer&nbsp;Password:</td>
<td><input type="password" name="c_pass" value="<?php echo $pass;?>">
</td>
</tr>
<tr>
...
<tr><td align="right">Customer Phone no:</td>
...
<td><input type="file" name="c_image" size="50"><img src="customer_photos/<?php echo $image; ?>" width="50" height="50">
</td>
</tr>
<tr>
