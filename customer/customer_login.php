...
<table width="800" bgcolor="#20F0E6" align="center">
<tr align="center"> 
...
if(isset($_POST['forgot_pass'])){
	...
	if($check_c==0){
		...
		exit();
			...
			<h3>Dear $c_name</h3>
			<p>You request for your password at www.bizzrise.com</p>
			...
			echo "<script>alert('Password was sent to your email,Pleasee check your inbox!')</script>";
...
if(isset($_POST['c_login'])){
	...
	if($check_customer==0){
		...
		echo "<script>alert('Password or Email address not correct,try again!')</script>";
		exit();
		}
		if($check_customer==1 AND $check_cart==0)
		{
			...
			echo"<script>window.open('customer/my_account.php','_self')</script>";
				 ...
				 $_SESSION['customer_email']=$customer_email;
				 echo "<script>alert('You succesfully logged in,you can order now!')</script>";
