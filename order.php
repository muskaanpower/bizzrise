...
//Getting Products Price & no of items
...
$empty_cart = "delete from cart where ip_add='$ip_add'";
	...
	<html>
	<p>
	Hello dear <b style='color:blue;'>$customer_name</b>you have ordered some product on our website please find your order details below and pay the dues as soon as posible </p>
	<table width='600' align='center' bgcolor='#2274E3' border='2'>
	
	<tr><td><h2>Your Order Details from bizrise.com</h2></td></tr>
	<tr>
	<th><b>S.N</b></th>
	...
	<h3>Please go to your acount and pay the dues </h3>
	<h2><a href='bizzrise.com'>Click here </a>to login to your account</h2>
	<h3>Thank you for ordering on www.bizzrise.com</h3>
	</html>
	";
